...
from .common import TestSaleStockCouponCommon


@tagged("post_install", "-at_install")
class TestSaleStockCouponInvoicing(TestSaleStockCouponCommon):
    def test_sale_stock_coupon_invoicing_full_delivery(self):
    ...
    def test_sale_stock_coupon_invoicing_partial_delivery(self):
        order = self.empty_order
        self.env["sale.order.line"].create(
            {
                "product_id": self.largeCabinet.id,
    ...
    def test_sale_stock_coupon_invoicing_partial_delivery_with_post_order_changes(self):
        order = self.empty_order
        self.env["sale.order.line"].create(
            {
                "product_id": self.largeCabinet.id,
    ...
    def test_sale_stock_coupon_invoicing_partial_delivery_fixed_amount(self):
    ...
    def test_sale_stock_coupon_invoicing_partial_delivery_specific_products(self):
