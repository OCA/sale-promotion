...
class TestSaleStockCoupon(TestSaleStockCouponCommon):
    def test_sale_stock_coupon_without_invoice_on_delivered_option(self):
    ...
    def test_sale_stock_coupon_full_delivery(self):
        order = self.empty_order
        self.env["sale.order.line"].create(
            {
                "product_id": self.largeCabinet.id,
    ...
    def test_sale_stock_coupon_partial_delivery(self):
        order = self.empty_order
        self.env["sale.order.line"].create(
            {
                "product_id": self.largeCabinet.id,
