...
class SaleOrder(models.Model):
    ...
    def _get_program_reward_lines(self, program):
    ...
    def _set_delivered_reward_qty_for_program_product(self, program):
        ...
        reward_lines = self._get_program_reward_lines(program)
        reward_lines.write(
    ...
    def recompute_coupon_lines(self):
        ...
        for program in applied_programs:
            ...
            valid_products = (
                ...
                if program.rule_products_domain and program.rule_products_domain != "[]"
                else products
            )
            qty_delivered = sum(
