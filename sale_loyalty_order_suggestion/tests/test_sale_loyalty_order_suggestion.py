...
class TestSaleLoyaltyOrderSuggestion(SaleCommon):
    ...
    def test_01_suggested_promotion_for_product_a_no_applicable(self):
        ...
        # the product added to the lines of the order but does not meet all the
        ...
        self.assertEqual(wiz_line_a.units_required, 3)
        ...
        self.assertEqual(wiz_line_b.units_required, 3)
