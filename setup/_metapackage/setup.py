...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-sale_coupon_financial_risk>=15.0dev,<15.1dev',
        ...
        'odoo-addon-sale_coupon_promotion_generate_coupon>=15.0dev,<15.1dev',
        'odoo-addon-sale_coupon_selection_wizard>=15.0dev,<15.1dev',
        'odoo-addon-sale_coupon_validity_notification>=15.0dev,<15.1dev',
