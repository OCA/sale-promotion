                    ...
                    Command.create(
                        {
                            ...
                            "sale_margin_formula": (
                                "result = origin_lines[0].margin + 19.00"
                            ),
                        }
                    )
                ],
    ...
    def test_reward_applies_and_margin_is_computed(self):
        ...
        for reward_line in reward_lines:
            ...
            self.assertEqual(
                reward_line.margin,
                # Negative margin
                -reward_line.product_id.standard_price * reward_line.product_uom_qty,
            )
        self.assertAlmostEqual(main_line.margin, 65.96)
        self.assertAlmostEqual(
            main_line.margin_percent, 65.96 / main_line.price_subtotal
        )
        self.assertAlmostEqual(order.margin, 15.44)
